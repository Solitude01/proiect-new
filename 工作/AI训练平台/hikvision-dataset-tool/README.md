...
3. （仅 `--auto` 模式需要）确保已安装并启动 bb-browser:
```bash
bb-browser
```
...
在GUI界面中：
1. 输入 Token、数据集ID、版本ID 后点击"连接"
2. 选择下载目录（可选，默认 ~/Downloads）
3. 点击"开始下载"
...
从当前浏览器页面自动提取信息并下载（需要 bb-browser）：
